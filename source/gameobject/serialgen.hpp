...
class serialgen_t {
	...
	// Our lock when accessing us, we declear it mutable in case used in const methods
...
public:
    ...
    serialgen_t(serial_t current, serial_t low=abs_floor, serial_t high=abs_ceiling) ;
