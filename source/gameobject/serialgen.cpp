...
//=================================================================================
serialgen_t::serialgen_t(serial_t current, serial_t low, serial_t high):ceiling(high),floor(low),nextserial(current){
...
auto serialgen_t::acquire() ->serial_t {
    ...
    if (serial > ceiling){
        throw std::runtime_error("Request for serial exceeded ceiling: "s+std::to_string(ceiling));
    }
    return serial ;
}
//=================================================================================
