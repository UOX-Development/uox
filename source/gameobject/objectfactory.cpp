...
static std::unordered_map<objecttype_t, std::string> objectnames{
    {objecttype_t::base, "base"s},
    {objecttype_t::item, "item"s},
    {objecttype_t::creature, "creature"s},
    {objecttype_t::character, "character"s},
    {objecttype_t::player, "player"s},
    {objecttype_t::boat, "boat"s},
    {objecttype_t::spawner, "spawner"s},
    {objecttype_t::building, "building"s},
...
auto typeForName(const std::string &name) -> objecttype_t {
    auto iter = std::find_if(
        objectnames.begin(), objectnames.end(),
        [&name](const std::pair<objecttype_t, std::string> &value) {
