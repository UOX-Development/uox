...
//=================================================================================
// This contains the basic information that the server needs to obtain all other
// information Any change to these data items, requires a restart of the server
//=================================================================================
enum class datalocation_t { server, shard, uodata };
enum relativepath_t {
    none,
    dictionary,
    log,
...
enum class filepath_t { account, firewall, setup };
...
class config_t {
  private:
    static const std::unordered_map<relativepath_t, std::filesystem::path>
        relativepath;
    ...
    auto process(const std::string &key, const std::string &value,
                 int linenumber) -> void;
  ...
  public:
    ...
    auto location(relativepath_t path, datalocation_t location) const
        -> std::filesystem::path;
    // Returns a complete file path for the specified file
    auto filepath(filepath_t path, datalocation_t location) const
        -> std::filesystem::path;
};
