...
//=================================================================================
argument_t::argument_t(int argc, char** argv):daemon(false),cfgpath(std::filesystem::path("uox.cfg")),executable() {
    // First look at the enviroment varaibles, and if they are set, setup the defaults
