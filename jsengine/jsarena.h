...
#define JS_ARENA_ALIGN(pool, n)                                                \
    (((jsuword)(n) + JS_ARENA_CONST_ALIGN_MASK) &                              \
...
#define JS_CLEAR_UNUSED(a)                                                     \
    (JS_ASSERT((a)->avail <= (a)->limit),                                      \
     memset((void *)(a)->avail, JS_FREE_PATTERN, (a)->limit - (a)->avail))
#define JS_CLEAR_ARENA(a)                                                      \
    memset((void *)(a), JS_FREE_PATTERN, (a)->limit - (jsuword)(a))
#else
 ...
 */
extern JS_PUBLIC_API(void) JS_InitArenaPool(JSArenaPool *pool, const char *name,
 ...
 */
extern JS_PUBLIC_API(void) JS_FreeArenaPool(JSArenaPool *pool);

/*
 * Free the arenas in pool and finish using it altogether.
 */
extern JS_PUBLIC_API(void) JS_FinishArenaPool(JSArenaPool *pool);

/*
 * Deprecated do-nothing function.
 */
extern JS_PUBLIC_API(void) JS_ArenaFinish(void);

/*
 * Deprecated do-nothing function.
 */
extern JS_PUBLIC_API(void) JS_ArenaShutDown(void);

/*
 * Friend functions used by the JS_ARENA_*() macros.
 */
extern JS_PUBLIC_API(void *) JS_ArenaAllocate(JSArenaPool *pool, size_t nb);
...
extern JS_PUBLIC_API(void) JS_ArenaRelease(JSArenaPool *pool, char *mark);
...
extern JS_PUBLIC_API(void) JS_ArenaCountRelease(JSArenaPool *pool, char *mark);

extern JS_PUBLIC_API(void) JS_ArenaCountRetract(JSArenaPool *pool, char *mark);

extern JS_PUBLIC_API(void) JS_DumpArenaStats(FILE *fp);
