...
#define PN_IS_CONSTANT(pn)                                                     \
    ((pn)->pn_type == TOK_NUMBER || (pn)->pn_type == TOK_STRING ||             \
...
extern JSBool js_CompileFunctionBody(JSContext *cx, JSTokenStream *ts,
                                     JSFunction *fun);

extern JSBool js_FoldConstants(JSContext *cx, JSParseNode *pn,
                               JSTreeContext *tc);
