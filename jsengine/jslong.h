...
JSInt64 __pascal __loadds __export JSLL_MaxInt(void);
JSInt64 __pascal __loadds __export JSLL_MinInt(void);
JSInt64 __pascal __loadds __export JSLL_Zero(void);
#else
...
#define JSLL_UDIVMOD(qp, rp, a, b)                                             \
    (*(qp) = ((JSUint64)(a) / (b)), *(rp) = ((JSUint64)(a) % (b)))
...
#define JSLL_UCMP(a, op, b)                                                    \
    (JS_ASSERT((#op)[1] != '='), JSLL_REAL_UCMP(a, op, b))
#else
...
#define JSLL_REAL_UCMP(a, op, b)                                               \
    (((a).hi op(b).hi) || (((a).hi == (b).hi) && ((a).lo op(b).lo)))
...
#define JSLL_NEG(r, a)                                                         \
    ((r).lo = -(JSInt32)(a).lo, (r).hi = -(JSInt32)(a).hi - ((r).lo != 0))
