...
extern uint8 *js_GetGCThingFlags(void *thing);
...
extern intN js_ChangeExternalStringFinalizer(JSStringFinalizeOp oldop,
                                             JSStringFinalizeOp newop);

extern JSBool js_InitGC(JSRuntime *rt, uint32 maxbytes);

extern void js_FinishGC(JSRuntime *rt);

extern JSBool js_AddRoot(JSContext *cx, void *rp, const char *name);

extern JSBool js_AddRootRT(JSRuntime *rt, void *rp, const char *name);

extern JSBool js_RemoveRoot(JSRuntime *rt, void *rp);

#ifdef DEBUG
extern void js_DumpNamedRoots(JSRuntime *rt,
                              void (*dump)(const char *name, void *rp,
                                           void *data),
                              void *data);
#endif

extern uint32 js_MapGCRoots(JSRuntime *rt, JSGCRootMapFun map, void *data);
...
extern JSBool js_RegisterCloseableIterator(JSContext *cx, JSObject *obj);
...
extern void js_RegisterGenerator(JSContext *cx, JSGenerator *gen);

extern JSBool js_RunCloseHooks(JSContext *cx);
...
extern void *js_NewGCThing(JSContext *cx, uintN flags, size_t nbytes);

extern JSBool js_LockGCThing(JSContext *cx, void *thing);

extern JSBool js_LockGCThingRT(JSRuntime *rt, void *thing);

extern JSBool js_UnlockGCThingRT(JSRuntime *rt, void *thing);

extern JSBool js_IsAboutToBeFinalized(JSContext *cx, void *thing);

extern void js_MarkAtom(JSContext *cx, JSAtom *atom);
 ...
 * a thing.
 */
extern void js_MarkGCThing(JSContext *cx, void *thing);

#ifdef GC_MARK_DEBUG

#define GC_MARK(cx, thing, name) js_MarkNamedGCThing(cx, thing, name)

extern void js_MarkNamedGCThing(JSContext *cx, void *thing, const char *name);
...
extern void js_MarkStackFrame(JSContext *cx, JSStackFrame *fp);
...
extern void js_GC(JSContext *cx, JSGCInvocationKind gckind);

/* Call this after succesful malloc of memory for GC-related things. */
extern void js_UpdateMallocCounter(JSContext *cx, size_t nbytes);
...
extern JS_FRIEND_API(void) js_DumpGCStats(JSRuntime *rt, FILE *fp);
