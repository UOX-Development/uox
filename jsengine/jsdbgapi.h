...
extern void js_PatchOpcode(JSContext *cx, JSScript *script, jsbytecode *pc,
                           JSOp op);
...
extern JS_PUBLIC_API(void) JS_ClearScriptTraps(JSContext *cx, JSScript *script);

extern JS_PUBLIC_API(void) JS_ClearAllTraps(JSContext *cx);
...
extern JS_PUBLIC_API(JSBool) JS_ClearAllWatchPoints(JSContext *cx);
 ...
 */
extern void js_MarkWatchPoints(JSContext *cx);

extern JSScopeProperty *js_FindWatchPoint(JSRuntime *rt, JSScope *scope,
                                          jsid id);

extern JSPropertyOp js_GetWatchedSetter(JSRuntime *rt, JSScope *scope,
                                        const JSScopeProperty *sprop);

extern JSBool JS_DLL_CALLBACK js_watch_set(JSContext *cx, JSObject *obj,
                                           jsval id, jsval *vp);

extern JSBool JS_DLL_CALLBACK js_watch_set_wrapper(JSContext *cx, JSObject *obj,
                                                   uintN argc, jsval *argv,
                                                   jsval *rval);

extern JSPropertyOp js_WrapWatchedSetter(JSContext *cx, jsid id, uintN attrs,
                                         JSPropertyOp setter);
 ...
 */
extern JS_PUBLIC_API(JSPrincipals *)
    JS_EvalFramePrincipals(JSContext *cx, JSStackFrame *fp,
                           JSStackFrame *caller);
...
extern JS_PUBLIC_API(JSBool) JS_IsNativeFrame(JSContext *cx, JSStackFrame *fp);
 ...
 */
extern JS_PUBLIC_API(uint32) JS_GetScriptFilenameFlags(JSScript *script);
 ...
 */
extern JS_PUBLIC_API(JSBool)
    JS_FlagScriptFilenamePrefix(JSRuntime *rt, const char *prefix,
                                uint32 flags);
 ...
 */
extern JS_PUBLIC_API(JSBool) JS_IsSystemObject(JSContext *cx, JSObject *obj);
 ...
 */
extern JS_PUBLIC_API(void) JS_FlagSystemObject(JSContext *cx, JSObject *obj);
